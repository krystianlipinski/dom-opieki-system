...
import { getAllPatients, Patient, deletePatient } from '../services/apiService'; // Upewnij się, że deletePatient jest importowane
...
const PatientsPage = () => {
  ...
  const handlePatientDeleted = (deletedPatientId: number) => {
    // Aktualizujemy stan, usuwając pacjenta z listy na frontendzie
